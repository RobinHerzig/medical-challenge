const { outputPatientData } = require('./outputPatientData');
let fs = require('fs');

describe('with given input.txt file', () => {
  const input = fs.readFileSync('./input.txt', 'utf-8');
  let result;

  beforeEach(() => {
    result = outputPatientData(input);
  });
...
describe('input edge cases', () => {
  ...
  describe('when input name contains space', () => {
